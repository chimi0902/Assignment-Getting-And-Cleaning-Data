...
This is done by the script run_analysis.R in 5 step:
- read data, list and variable list
- Merges the training and the test data and labels
- Extracts mean and standard deviation on data set 
